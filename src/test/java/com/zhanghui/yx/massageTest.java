...
public class massageTest {
    ...
    public SendSmsResponse send(LoginVo loginVo) throws ClientException {
        //设置超时时间-可自行调整
        ...
        IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", loginVo.getAccessKeyId(),
                loginVo.getAccessKeySecret());
        ...
        request.setTemplateParam("code\":\"546545\"}");
